...
**Workflow templates:** `basic`, `entity-trigger`, `document`, `scheduled`, `scheduled-execute`, `utility`, `webhook`, `public-api`, `mcp-tool`, `agent`, `ftp-tracking`, `ftp-edi`, `api-tracking`
